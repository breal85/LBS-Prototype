    ...
    <body>
        ...
        <div class="main-container">
...

            {
                ...
                $query = "SELECT small_business.Business_Name,products.ProductID, products.BusinessID,products.Product_Name,products.Product_Price, products.Product_Details, product_category.Category_Name FROM product_category, products, small_business WHERE small_business.BusinessID = products.BusinessID AND products.Product_Name = '$product_name' AND products.Category_ID = product_category.Category_ID";
			...
			<tr>
                       ...
                       <td> <label class="product_label">Product Name:</label></td>
                        ...
                        <?php echo '<a href="productdetails.php?id='.$rowProductInfo['ProductID'].'&b_id='.$rowProductInfo['BusinessID'].'">More details...</a>' ?>
