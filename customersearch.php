...
<body>
	...
	<article>
		...
		<section id="map_section">
            ...
            <p style="display:none;"><u><b>Coordinates</b></u></p>
            <p style="display:none;"><b>Latitude</b>:<span id="lat"></span></p>
            <p style="display:none;"><b>Longitude</b>:<span id="long"></span></p>
            <p id="error"></p>
		</section>
		<!--Form section for inputting product search criteria-->
		<section id="search_section">
        <p>Enter product name and search:</p>
        <form name="product_search_form" action="productsearch.php" method="post">
